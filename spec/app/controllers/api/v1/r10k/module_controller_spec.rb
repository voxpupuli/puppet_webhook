...
describe 'Api::V1::R10K::ModuleController' do
  context 'valid body' do
    ...
    it 'responds with a 200' do
      stub_request(:post, 'localhost/api/v1/r10k/module')
        .with(body: body, headers: headers).to_return(status: 200)

      Net::HTTP.post URI('http://localhost/api/v1/r10k/module'), body, headers
    end
  end
